...
################################################################################
  ...
  def pbDragonDartTargetting(attacker) # all of this just to get dragon darts targeting right, i hate it here
    ...
    if opp2.effects[:SkyDrop] || opp2.effects[:Commander] # Gen 9 Mod - Added Commander immunity when inside Dondozo's mouth.
      return [opp1]
    end
    if opp1.effects[:SkyDrop] || opp2.effects[:Commander] # Gen 9 Mod - Added Commander immunity when inside Dondozo's mouth.
      return [opp2]
    end
