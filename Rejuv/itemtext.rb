...
:ICEHEAL => {
    :ID => 227,
    :name => "Ice Heal",
    :desc => "A spray-type medicine. It heals a Pokémon that has been afflicted by frostbite.",
    :price => 250,
    :medicine => true,
    :status => true,
},
...
:TM14 => {
    :ID => 301,
    :name => "TM14",
    :desc => "A howling blizzard is summoned to strike the opposing team. It may also leave them with frostbite.",
    :price => 100000,
    :tm => :BLIZZARD,
    :noUseInBattle => true,
},
...
:RM09 => {
    :ID => 895,
    :name => "RM09",
    :desc => "The user strikes with a simultaneous three-beam attack. May also burn or frostbite or paralyze the target.",
    :price => 20000,
    :tm => :TRIATTACK,
    :noUseInBattle => true,
},
...
:TM140 => {
    :ID => 971,
    :name => "TM140",
    :desc => "The user bites with cold-infused fangs. This may also make the target flinch or leave it with frostbite.",
    :price => 10000,
    :tm => :ICEFANG,
    :noUseInBattle => true,
},
